...
<!--[if (gt IE 9)|!(IE)]><!--> <html lang="en" class="no-js"> <!--<![endif]-->
  ...
  <option value="Praise and Worship">Ministry of Altar Server</option>
  <option value="Ushering">Lectors and Commentators Ministry</option>
  <option value="Hostessing">Lay Minister</option>
  <option value="Media and IT">Choir</option>
  <option value="Sunday School">Youth</option>
</select> 
                                </p>
								 <p> 
